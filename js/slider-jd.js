...
Refresh.Web.Slider.prototype = {
    ...
    setArrowPositionFromValues: function (e) {
        ...
        if (this.settings.yMinValue !== this.settings.yMaxValue) {
            ...
            if (this.yValue === this.settings.yMinValue) {
                ...
                let arrowOffsetY = yValue / yMax * this._barHeight;
    ...
    _setArrowPosition: function (offsetX, offsetY) {
        ...
        let posX = this._barLeft + offsetX;
        let posY = this._barTop + offsetY;
    ...
    setValuesFromMousePosition: function (e) {
        ...
        const newXValue = parseInt(relativeX / this._barWidth * this.settings.xMaxValue);
        const newYValue = parseInt(relativeY / this._barHeight * this.settings.yMaxValue);
